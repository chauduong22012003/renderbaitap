...
ADD main.war /usr/local/tomcat/webapps/
ADD ch05_ex1_email.war /usr/local/tomcat/webapps/
...
ADD ch07_ex1_download.war /usr/local/tomcat/webapps/
ADD ch07_ex2_download.war /usr/local/tomcat/webapps/
